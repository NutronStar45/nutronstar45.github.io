...
import { PROGRESS_REPORT_INTERVAL, MazeShape, GenerateParams, GenerateAlgorithm } from "./maze_util.mjs";
...
function prims(graph) {
    ...
    while (verticesSearching.length > 0) {
        ...
        const potentialNeighborsFinished = graph.neighbors(extension)
        ...
        const defaultNeighbors = graph.neighbors(extension)
