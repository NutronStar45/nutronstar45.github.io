 ...
 */
export function directionDifference(direction, width) {
    switch (direction) {
        case "left":
            return -1;
        case "right":
 ...
 */
export function adjacentDirections(square, width, height) {
    let directions = [];
    if (square % width !== 0)
 ...
 */
export function neighbors(square, width, height) {
 ...
 */
export function connectedNeighbors(square, maze) {
 ...
 */
export function checkDeadend(square, maze) {
