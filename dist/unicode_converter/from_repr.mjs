 ...
 */
function fromUTF8Units(codeUnits) {
    let codePoints = [];
 ...
 * @throws {RangeError} Thrown when the given sequence is ill-formed.
 */
function fromUTF16Units(codeUnits) {
    let codePoints = [];
...
export function fromRepresentation(str, representation) {
    switch (representation) {
        ...
        case Representation.UTF16BEDec:
            return fromUTF16Units(codeUnitsFromBytes(parseIntegersWhitespace(str, 10, 3), 2, Endianness.Big));
