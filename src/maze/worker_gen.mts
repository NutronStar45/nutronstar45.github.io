...
import { PROGRESS_REPORT_INTERVAL, type Subgraph, MazeShape, GenAlg } from "./util.mjs";
import { type Maze, GenParams } from "./shapes/shapes.mjs";
...
function prims<V, T extends Subgraph<V>>(graph: T) {
    ...
    let verticesSearching: V[] = [];
    let verticesFinished: V[] = [];
